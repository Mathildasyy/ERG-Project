...
num.feature <- preprocess.getNum(train.2,1:58)
cat.feature <- preprocess.getCat(train.2, 1:58)
trainNum2 <- preprocess.corNum2Num(train.2,num.feature)
